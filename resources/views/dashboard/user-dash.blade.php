                    ...
                    <tr>
                        ...
                        <th>
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center">
                                    <button class="btn btn-danger  me-1" onclick="deleteUser(3)" data-bs-toggle="modal" data-bs-target="#delete-user">
                                        <i class="fa-regular fa-trash-can "></i>
                                    </button>
                                    <button class="btn btn-warning edit-userbutton" data-user-id="3"  data-bs-target="#edit-user" data-bs-toggle="modal" >
